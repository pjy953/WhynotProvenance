...
for L in range(1, len(conditions)+1):
    for subset in itertools.combinations(conditions, L):
        ...
        if not text4 == "where ":
            ...
            query = text1 + text2 + text4 + " and o_orderdate<'1996-01-01' and l_extendedprice>50000"#and l_extendedprice>100000 and o_orderdate=l_commitdate and c_nationkey=4"#"
        else:
